...
do
    ...
    # ./test_decom_all /mnt/beegfs/image_32KB_10428 out_0415.csv
    # ./test_decom_all /mnt/beegfs/test_dir_1MB_10428 out_0425.csv
    ./test_decom_all /mnt/beegfs/image_32KB_10428 out_0425_image.csv
