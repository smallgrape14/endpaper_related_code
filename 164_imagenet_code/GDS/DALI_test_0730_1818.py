...
#加载数据集合的关键代码-------------------
    ...
    # for epoch in range(1,10):
        ...
        #DALI 预处理的加载模式
        train(train_data, model, criterion, optimizer, epoch, device, args,file_num,batch_data_list,batch_train_list,batch_todevice_list)
    ...
    csv_file_path = "result/0730/avg_batch_time_BeeGFS_GDS.csv"
        # 检查文件是否存在并且是否有表头
    ...
    with open(csv_file_path, mode='a', newline='') as csv_file:
        fieldnames = ['batch_size','worker_num','prefetch_factor','data_time','training_time']#, 'data_todevice_time']
...
def train(train_loader, model, criterion, optimizer, epoch, device, args,file_num,batch_data_list,batch_train_list,batch_todevice_list):
