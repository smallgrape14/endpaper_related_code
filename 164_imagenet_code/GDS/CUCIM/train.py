...
with open("/mnt/nvme0/gdstest/gdsio.0", "wb") as input_file:
# with open("/mnt/beegfs/gdsio_0728/gdsio.0", "wb") as input_file:

# with open("/mnt/nvme0/input.raw", "wb") as input_file:
# with open("/mnt/beegfs/input.raw", "wb") as input_file:
    input_file.write(
