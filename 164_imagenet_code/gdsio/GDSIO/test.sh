...
do
    ...
    for threadnum in 1; do
    # for threadnum in 1 2 4 8 16 32; do
        for IOSIZE in "8KB";do
        # for IOSIZE in "512B" 1"1K" "2K" "4K" "8K" "16K" "32K" "64K" "128K" "256K" "512K" "1M";do # "1M" "2M" "4M" "8M" "16M" "32M" "64M"; do
        # for threadnum in 1 2 4 8 16 32 64 128 256; do
        # for threadnum in 256 128 64 32 16; do
        # for threadnum in 1 2 4 8; do
            ...
            # /usr/local/cuda-12.4/gds/tools/gdsio -f /mnt/nvme0/gdstest/gdsio.0 -w $threadnum -d 0 -I 0 -x 0 -s 1G -i $IOSIZE >> $output_file
            # 
            output_file="output_Beegfs.txt"
