...
#
mkdir /mnt/beegfs/imagenet
 
#
# Extract the training data:
#
# Create train directory; move .tar file; change directory
mkdir /mnt/beegfs/imagenet/train && mv /mnt/beegfs/ILSVRC2012_img_train.tar /mnt/beegfs/imagenet/train/ && cd /mnt/beegfs/imagenet/train
...
mkdir /mnt/beegfs/imagenet/val && mv /mnt/beegfs/ILSVRC2012_img_val.tar /mnt/beegfs/imagenet/val/ && cd /mnt/beegfs/imagenet/val && tar -xvf ILSVRC2012_img_val.tar && rm -f ILSVRC2012_img_val.tar
