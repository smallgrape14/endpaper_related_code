...
#
mkdir /mnt/beegfs/imagenet_t3
 
#
# Extract the training data:
#
# Create train directory; move .tar file; change directory
mkdir /mnt/beegfs/imagenet_t3/train && mv /mnt/beegfs/ILSVRC2012_img_train.tar /mnt/beegfs/imagenet_t3/train/ && cd /mnt/beegfs/imagenet_t3/train
...
mkdir /mnt/beegfs/imagenet_t3/val && mv /mnt/beegfs/ILSVRC2012_img_val.tar /mnt/beegfs/imagenet_t3/val/ && cd /mnt/beegfs/imagenet_t3/val && tar -xvf ILSVRC2012_img_val.tar && rm -f ILSVRC2012_img_val.tar
