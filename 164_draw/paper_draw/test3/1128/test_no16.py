...
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#7f7f7f', '#e377c2', '#bcbd22']
...
# 优化布局并保存
plt.tight_layout()
plt.savefig('batch_time_comparison_no16.png', dpi=300, bbox_inches='tight')
plt.savefig('batch_time_comparison_no16.pdf', format='pdf', bbox_inches='tight')
plt.show()