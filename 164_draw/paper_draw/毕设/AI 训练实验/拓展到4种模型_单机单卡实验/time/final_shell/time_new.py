...
def save_individual_plots(baseline_df, ours_df, output_dir="individual_plots"):
    ...
    for model in models:
        ...
        ax1.set_xlabel('批大小（Batch Size）', fontsize=FONT_SIZE_LABEL, fontproperties='SimHei')
        ax1.set_ylabel('数据加载时间占比 (%)', fontsize=FONT_SIZE_LABEL, fontproperties='SimHei')
        ax1.set_xticks(x_pos)
        ax1.set_xticklabels(all_batchsizes, fontsize=FONT_SIZE_TICK, fontproperties='SimHei')
