...
# 从 CSV 文件读取数据
import pandas as pd
csv_path = "csv_file/multiGPU_w8.csv"  # 替换为您的实际文件路径
...
plt.tight_layout()
# plt.show()
plt.savefig("2.2.1_w8.png", dpi=300, bbox_inches='tight')  # 保存图表为PNG文件
...
plt.tight_layout()
# plt.show()
plt.savefig("2.2.2_w8.png", dpi=300, bbox_inches='tight')  # 保存图表为PNG文件
