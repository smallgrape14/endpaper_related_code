...
data = {
    ...
    'T1:SSD->CPU->GPU': [2095.5481, 2075.7202, 1935.5423, 1985.761, 1924.22],
    'T2: SSD->GPU': [425.220172, 441.8100342, 445.7089844, 466.4164062, 507.0514648]
}
...
ax1.legend(loc='upper right', bbox_to_anchor=(1.05, 1.15), fontsize=FONT_SIZE_LEGEND, frameon=False)
...
# 保存图表
performance_comparison_chart = 'small_IO_local_SSD_to_GPU_latency_comparison.png'
plt.tight_layout()
plt.savefig(performance_comparison_chart, dpi=300, bbox_inches='tight', facecolor='white')
plt.savefig('small_IO_local_SSD_to_GPU_latency_comparison.pdf', dpi=300, bbox_inches='tight', facecolor='white')
