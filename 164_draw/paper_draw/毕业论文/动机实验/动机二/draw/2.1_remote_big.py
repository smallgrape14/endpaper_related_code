...
# T1: SSD->CPU->GPU 路径延迟
t1_latency = [3890.6, 5777.87, 9049.25, 15723.6, 28804.4]

# T2: SSD->GPU 路径延迟
t2_latency = [1798.523438, 3534.609375, 6832.46875, 12593.375, 20144.125]
# 创建新的大IO尺寸数据
data = {
...
# 保存图表
performance_comparison_chart = 'large_IO_remote_SSD_to_GPU_latency_comparison.png'
plt.tight_layout()
plt.savefig(performance_comparison_chart, dpi=300, bbox_inches='tight', facecolor='white')
plt.savefig('large_IO_remote_SSD_to_GPU_latency_comparison.pdf', dpi=300, bbox_inches='tight', facecolor='white')
