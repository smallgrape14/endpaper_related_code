...
plt.rcParams['font.serif'] = ['DejaVu Sans','Times New Roman' ]  # Times + 宋体
...
# 设置左侧y轴
ax1.set_xlabel('Host Current Threads', fontsize=FONT_SIZE_LABEL)
ax1.set_ylabel('Throughput (KIOPS)', fontsize=FONT_SIZE_LABEL)
...
y_ticks = np.arange(0, 401, 100)  # 0, 50, 100, ..., 450
...
# 保存图表
performance_comparison_chart = 'beeGFSvsEXT4_local.png'
performance_comparison_chart_pdf = 'beeGFSvsEXT4_local.pdf'
