...
data = {
    ...
    '客户端_IOPS': [1361.54, 2461.18, 4277.28, 7840.6, 12905.9, 24887.8, 23972.4, 10554.7, 5555.67, 2788.24, 1086.59],
    ...
    'SSD_利用率':[1361.54/10484*100, 2461.18/30036*100, 4277.28/68476*100, 7840.6/132862*100, 12905.9/234880*100, 24887.8/372224*100, 23972.4/374784*100, 10554.7/342528*100, 5555.67/326400*100, 2788.24/361472*100, 1086.59/374528*100]
}
...
# 保存图表
performance_comparison_chart = '动机一BeeGFSvsSSD_本地节点.png'
performance_comparison_chart_pdf = '动机一BeeGFSvsSSD_本地节点.pdf'

plt.tight_layout()
plt.savefig(performance_comparison_chart, dpi=300, bbox_inches='tight', facecolor='white')
plt.savefig(performance_comparison_chart_pdf, dpi=300, bbox_inches='tight', facecolor='white')
